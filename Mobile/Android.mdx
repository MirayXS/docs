...
[**Droid-ify**](https://github.com/Iamlooker/Droid-ify) | [**F-Droid**](https://f-droid.org/) - Decentralized store for downloading libre (FOSS) applications.
...
[**IronFox**](https://ironfoxoss.org/) - Privacy oriented and deblobbed Firefox fork which enables many features upstreamed by the [Tor uplift](https://wiki.mozilla.org/Security/Tor_Uplift) project using preferences from the [arkenfox-user.js](https://github.com/arkenfox/user.js/) project.
...
[**Bitwarden**](https://github.com/bitwarden/mobile) - Open-source & self-hostable password manager. There's also an unofficial [Material You](https://github.com/AChep/keyguard-app) client, with additional features.
...
[**VLC for Android**](https://videolan.org/vlc/download-android.html) - Another Open-source media player which has the ability to play various media formats, network streams etc. along with other useful features.
...
[**SpotiCap**](https://t.me/s/spoticap) - Open-source Custom Spotify client which utilizes the Web App, unlocking features such as ad-blocking and skipping tracks.
...
[**NagramX**](https://github.com/risin42/NagramX) | [**AyuGram**](https://t.me/ayugramfcm) - Telegram Clients with Ghost mode, Message history, disabled ads and more.
